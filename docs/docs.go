...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/implements": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.Implement"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Date utilaj agricol",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateImplementRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/profile/photo": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Fișier imagine (jpg/png/webp, max 5MB)",
                        "name": "photo",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/weather/current": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Numele locatiei afisat in raspuns",
                        "name": "location",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.CurrentWeatherResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.DashboardCard": {
            ...
            "properties": {
                "key": {
                    "$ref": "#/definitions/domain.DashboardCardKey"
                },
                "label": {
                    "type": "string"
                },
        ...
        "domain.DashboardCardKey": {
            ...
            "x-enum-varnames": [
                "DashboardCardTotalMachines",
                "DashboardCardActiveMachines",
        ...
        "domain.Implement": {
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/domain.ImplementType"
                },
                "updatedAt": {
                    "type": "string"
                },
        ...
        "domain.Machine": {
            ...
            "properties": {
                ...
                "fuel_type": {
                    "$ref": "#/definitions/domain.FuelType"
                },
                "id": {
                    "type": "integer"
                },
        ...
        "handlers.CreateImplementRequest": {
            "type": "object",
            "required": [
                "code",
                "name",
        ...
        "handlers.CurrentWeatherResponse": {
            "type": "object",
            "properties": {
                "cloud_cover_percent": {
                    "type": "integer"
        ...
        "handlers.DashboardCardsResponse": {
            "type": "object",
            "properties": {
                "cards": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.DashboardCard"
                    }
                }
            }
        },
